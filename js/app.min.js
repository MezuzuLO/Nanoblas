...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_function_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/function.js */ \"./src/js/modules/function.js\");\n/* harmony import */ var _modules_swiper_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/swiper.js */ \"./src/js/modules/swiper.js\");\n/* harmony import */ var _modules_headerButtonAnimation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/headerButtonAnimation.js */ \"./src/js/modules/headerButtonAnimation.js\");\n/* harmony import */ var _modules_headerMobileOpen_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/headerMobileOpen.js */ \"./src/js/modules/headerMobileOpen.js\");\n/* harmony import */ var _modules_bestsellerTypeSelecting_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/bestsellerTypeSelecting.js */ \"./src/js/modules/bestsellerTypeSelecting.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n_modules_function_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\r\n\r\nconsole.log('hello')\n\n//# sourceURL=webpack://gulp-2022/./src/js/app.js?");

/***/ }),

/***/ "./src/js/modules/bestsellerTypeSelecting.js":
/*!***************************************************!*\
  !*** ./src/js/modules/bestsellerTypeSelecting.js ***!
  \***************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n$(function () {\r\n\tconst bestsellerTypeArray = []\r\n\t$('.shop-type__block').each((index) => {\r\n\t\tif (index === 0) {\r\n\t\t\tbestsellerTypeArray.push(1)\r\n\t\t\t$('.shop-catagory').eq(index).fadeIn(0)\r\n\t\t} else {\r\n\t\t\tbestsellerTypeArray.push(0)\r\n\t\t\t$('.shop-catagory').eq(index).fadeOut(0)\r\n\t\t}\r\n\t\t$('.shop-type__block').eq(index).click(() => {\r\n\t\t\tbestsellerTypeArray.forEach((el, arrayIndex) => {\r\n\t\t\t\tif (bestsellerTypeArray[arrayIndex] === 1 || arrayIndex !== index) {\r\n\t\t\t\t\t$('.shop-type__block').eq(arrayIndex).removeClass('shop-type__block-selected')\r\n\t\t\t\t\t$('.shop-catagory').eq(arrayIndex).fadeOut(0)\r\n\t\t\t\t\tbestsellerTypeArray[arrayIndex] = 0\r\n\t\t\t\t}\r\n\t\t\t})\r\n\t\t\tbestsellerTypeArray[index]++\r\n\t\t\t$('.shop-type__block').eq(index).addClass('shop-type__block-selected')\r\n\t\t\t$('.shop-catagory').eq(index).fadeIn(200)\r\n\t\t})\r\n\t})\r\n})\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/bestsellerTypeSelecting.js?");
...
/***/ "./src/js/modules/headerButtonAnimation.js":
/*!*************************************************!*\
  !*** ./src/js/modules/headerButtonAnimation.js ***!
  \*************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n$(function () {\r\n\tconst headerButtonHovered = [0, 1]\r\n\t$('.header-sing__button').each((index) => {\r\n\t\t$('.header-sing__button').eq(index).mouseover(() => {\r\n\t\t\theaderButtonHovered.forEach((el, arrayIndex) => {\r\n\t\t\t\tif (headerButtonHovered[arrayIndex] === 1 && arrayIndex !== index) {\r\n\t\t\t\t\t$('.header-sing__button').eq(arrayIndex).css({\r\n\t\t\t\t\t\t'transition': 'background-color 0.2s linear',\r\n\t\t\t\t\t\t'background-color': 'transparent'\r\n\t\t\t\t\t})\r\n\t\t\t\t\theaderButtonHovered[arrayIndex] = 0\r\n\t\t\t\t}\r\n\t\t\t})\r\n\t\t\tif (headerButtonHovered[index] !== 1) {\r\n\t\t\t\theaderButtonHovered[index] += 1\r\n\t\t\t}\r\n\t\t\t$('.header-sing__button').eq(index).css({\r\n\t\t\t\t'transition': 'background-color 0.2s linear',\r\n\t\t\t\t'cursor': 'pointer',\r\n\t\t\t\t'background-color': 'rgba(35, 166, 240, 1)'\r\n\t\t\t})\r\n\t\t})\r\n\t})\r\n})\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/headerButtonAnimation.js?");

/***/ }),

/***/ "./src/js/modules/headerMobileOpen.js":
/*!********************************************!*\
  !*** ./src/js/modules/headerMobileOpen.js ***!
  \********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n$(function () {\r\n\tlet headerSearchClicks = 0\r\n\tlet headerBurgerClicks = 0\r\n\t$('.header-search-menu').slideUp(0)\r\n\t$('.header-burger-menu').slideUp(0)\r\n\t$('.header-search__icon').click(() => {\r\n\t\theaderBurgerClicks = 0\r\n\t\theaderSearchClicks++\r\n\t\tif (headerSearchClicks === 1) {\r\n\t\t\t$('.header-burger-menu').slideUp(0)\r\n\t\t\t$('.header-search-menu').slideDown(200)\r\n\t\t}\r\n\t\telse if (headerSearchClicks === 2) {\r\n\t\t\t$('.header-search-menu').slideUp(200)\r\n\t\t\theaderSearchClicks = 0\r\n\t\t}\r\n\t})\r\n\t$('.header-burger__icon').click(() => {\r\n\t\theaderSearchClicks = 0\r\n\t\theaderBurgerClicks++\r\n\t\tif (headerBurgerClicks === 1) {\r\n\t\t\t$('.header-search-menu').slideUp(0)\r\n\t\t\t$('.header-burger-menu').slideDown(200)\r\n\t\t}\r\n\t\telse if (headerBurgerClicks === 2) {\r\n\t\t\t$('.header-burger-menu').slideUp(200)\r\n\t\t\theaderBurgerClicks = 0\r\n\t\t}\r\n\t})\r\n})\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/headerMobileOpen.js?");
